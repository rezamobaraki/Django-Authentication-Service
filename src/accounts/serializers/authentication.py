...
from accounts.services.queries.authentication import (
    authentication_register_retrieve_cellphone_with_token,
...
class AuthSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        if User.objects.filter(cellphone=validated_data["cellphone"]).exists():
            return authentication_login_token(cellphone=validated_data["cellphone"])
        return authentication_register_send_otp(cellphone=validated_data["cellphone"])
...
class RegisterVerifySerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        return authentication_register_token(cellphone=validated_data["cellphone"])
...
class RegisterInformationSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        return authentication_register_information(
